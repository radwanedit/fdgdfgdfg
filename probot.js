...
client.on('message', msg => {
   if(msg.content === 'هلا') {
     msg.reply('هلا ولله كيف حالك اليوم ؟!');
  }
});
client.on('message', msg => {
   if(msg.content === 'السلام عليكم') {
     msg.reply('و عليكم السلام و رحمة الله و بركاته');
  }
});
client.on('message', msg => {
  if (msg.content === 'تمام') {
    msg.reply('ك الحمدلله!');
  }
});
client.on('message', message => {
    if (message.content.startsWith('^^مقبول')) {
        ...
        let Room = message.guild.channels.find(`name`, 'مقبول-او-مرفوض')
...
client.on('message', message => {
    ...
    if (message.content.startsWith(prefix + 'مرفوض')) {//هنا الأمر
        if (message.author.bot) return;
        if (!message.guild) return;
        let Room = message.guild.channels.find(`name`, 'مقبول-او-مرفوض');
        let user = message.mentions.users.first();
...
client.on("message", message => {
 ...
 if (message.content === "^^help") {
  ...
  const embed = new Discord.RichEmbed()
      .setColor("RANDOM")
      .addField("『Vine Bot』 『اسم البوت』", true)
      
      .addField("『@مصمم البوت』『!-FB ,وسيط| FS#9103』", true)
...
القسم الثالث مصمم البوت | @!-FB ,وسيط| FS#9103 
...
if (message.content === '^^invite') {
      message.author.send(' رابط البوت |  https://discordapp.com/api/oauth2/authorize?client_id=554776265760964633&permissions=0&scope=bot ').catch(e => console.log(e.stack));
